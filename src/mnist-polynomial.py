...
def create_baseline_model(D, C):
    ...
    act = src.modules.polynomial.Activation(8, n_degree=32, a=-3, b=3)
        ...
        src.modules.ResNet(
            ...
            src.modules.ResBlock(
                block = torch.nn.Sequential(
                    ...
                    src.modules.PrototypeSimilarity(d*2, 4, r=3),
                    Random(p=0.05, a=-3, b=3),
                    src.modules.polynomial.Activation(4, n_degree=16, a=-4, b=4),
            ...
            src.modules.ResBlock(
                block = torch.nn.Sequential(
                    ...
                    src.modules.PrototypeSimilarity(d*4, 4, r=3),
                    Random(p=0.05, a=-3, b=3),
                    src.modules.polynomial.Activation(4, n_degree=32, a=-4, b=4),
                    torch.nn.Dropout2d(p=0.05),
